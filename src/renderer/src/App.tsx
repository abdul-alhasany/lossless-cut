          ...
          <ThemeProvider value={theme}>
            <Tooltip.Provider delayDuration={0}>
              <div className={darkMode ? 'dark-theme' : undefined} style={{ ...baseColorStyle, display: 'flex', flexDirection: 'column', height: '100vh', transition: darkModeTransition }}>
                ...
                <CustomDialog open={streamsSelectorShown}>
                  <DialogContent
                    title={t('Tracks')}
                    onCloseClick={() => setStreamsSelectorShown(false)}
                    style={{ width: '1000px' }}
                  >
                ...
                <CustomDialog open={settingsVisible}>
                  <DialogContent
                    title={t('Settings')}
